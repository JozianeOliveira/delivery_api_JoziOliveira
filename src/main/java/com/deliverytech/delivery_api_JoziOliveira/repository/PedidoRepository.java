package com.deliverytech.delivery_api_JoziOliveira.repository;
 
import com.deliverytech.delivery_api_JoziOliveira.entity.Pedido;
...
public interface PedidoRepository extends JpaRepository<Pedido, Long> {
    ...
    @Query("SELECT p FROM Pedido p WHERE FUNCTION('DATE', p.dataPedido) = CURRENT_DATE ORDER BY p.dataPedido DESC")
